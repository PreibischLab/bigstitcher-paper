...
\textbf{Supplementary Table \ref{tab:datasets}} & Datasets used in this publication \tablespace \\
...
\subsection*{\red{SUPPLEMENTARY FIGURE 1: Fluorescence preservation in cleared samples}}
\vspace{1mm}
\begin{figure*}[ht!]
\includegraphics[width=\textwidth]{fig-rf.png}
\vspace{-2.0mm}
\caption{\hspace{-0.5mm} \emph{Fluorescence preservation and image analysis in cleared samples.} \textbf{(a)-(d)} Optical sections through an adult mouse hypothalamus in a CLARITY-cleared adult mouse brain expressing H2B-GFP in all bsx neurons. Fluorescence is preserved throughout the clearing procedure. \red{However, the signal is degrading with imaging depth and can typically be recorded up to 1 -- 2 cm into the sample, depending on the tissue type and the quality of the clearing process. This maximal imaging depth limits the size of the sample that can be acquired from a single orientation. The brightness and contrast was adjusted individually for each slice. Slight saturation was used to also display the autofluorescent signal.} 
}
...
\begin{longtable}{lll}
\caption{Supplementary Table 1: \emph{Summary of all datasets used in this publication}. \label{tab:datasets} }\\ \\

\toprule
                                                                                                                                                       \thead[l]{ \textbf{Dataset}} &                                                                                                                                                                \thead[l]{\textbf{Size}} &                                                                                                                                                                                                                                                                                                                                                \thead[l]{\textbf{Microscope \& Acquisition settings}} \\
\midrule \\
\endhead
\midrule
...
\endlastfoot
 ...
 \multirowcell{2}[-4ex][l]{Coronal slice through an adult \\mouse brain expressing an H2B-eGFP \\lineage tracing marker in BSX-expressing \\neurons (\textbf{Figure 2b + Supplement})} &            \makecell[l]{1920$\times$1920$\times$828 16 bit stacks\\35 tiles from 2 angles (10\% overlap) \\2 channels, dual illumination\\\textbf{0.78 TB total size}}  &                                                                    \makecell[l]{Lightsheet Z.1 with EC Plan-Neofluar 5x/0.16 objective \\10.44$\mu{}m$ LS thickness, 2034.834282$\mu{}m$ Confocal parameter\\0.915$\times$0.915$\times$4.930096618$\mu{}m$ pixels\\119.8ms exposure on PCO.edge camera\\lasers: 561 nm 50\%, 488 nm 50\%\\filters: EF1 BP 505-545, EF 2 BP 575-615} \\ \\
                          ...
                          \makecell[l]{Central nervous system of a Drosophila\\ 1st instar larva with immunostaining \\for tubulin(\textbf{Figure 2c,e + Supplement})} &                     \makecell[l]{2048$\times$2048$\times$923 stacks\\? tiles from 4 angles (28\% overlap) \\1 channels, dual illumination\\\textbf{? TB total size}}  &                                                                                                                \makecell[l]{IsoView with SpecialOptics 16x/NA 0.71 objective \\4.92$\mu{}m$ LS thickness, 416.0$\mu{}m$ Confocal parameter\\0.4125$\times$0.4125$\times$0.8125$\mu{}m$ pixels\\?ms exposure on Orca Flash 4.0 v2 sCMOS camera\\lasers: 488 nm Laser?\\filters: ?} \\ \\
\end{longtable}
