...
\vspace{1mm}
\begin{figure*}[h!]
\center\includegraphics[width=\textwidth-2.5cm]{fig-expansion_tiling.jpg}
\vspace{2.0mm}
\caption{\hspace{-0.5mm} \emph{Expansion microscopy stitching} \textbf{(A)} All tiles of one view of the expanded Drosophila central nervous system. Each image tile is randomly colored. Dotted lines highlight orthogonal sections in (B) and (C). \textbf{(B,C)} Orthogonal view showing the stitching of the orthogonal angle at two different cut planes.
}
